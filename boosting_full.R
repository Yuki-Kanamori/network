...
write.csv(isi_imp, "isi_imp_full.csv")
write.csv(isi_pred, "isi_pred_full.csv")
...
write.csv(kono_imp, "kono_imp_full.csv")
...
save(train_ika, file = paste0("tuned_params_ika_full", ".RData"))
...
write.csv(ika_imp, "ika_imp_full.csv")
write.csv(ika_pred, "ika_pred_full.csv")
...
save(train_ebi, file = paste0("tuned_params_ebi_full", ".RData"))
...
write.csv(ebi_imp, "ebi_imp_full.csv")
write.csv(ebi_pred, "ebi_pred_full.csv")
write.csv(ebi_cor, "ebi_cor_full.csv")
write.csv(ebi_mae, "ebi_mae_full.csv")
...
save(train_ana, file = paste0("tuned_params_ana_full", ".RData"))
...
for(i in 1:4){
  assign(paste0("ana", i),
         ana %>% filter(n_season == i) %>% select(log_abundance, do_0, do_5, do_10, do_20, do_50, sal_0, sal_5, sal_10, sal_20, sal_50, wt_0, wt_5, wt_10, wt_20, wt_50)
  )
}
...
write.csv(ana_imp, "ana_imp_full.csv")
write.csv(ana_pred, "ana_pred_full.csv")
write.csv(ana_cor, "ana_cor_full.csv")
write.csv(ana_mae, "ana_mae_full.csv")
...
save(train_mako, file = paste0("tuned_params_mako_full", ".RData"))
...
write.csv(mako_imp, "mako_imp_full.csv")
write.csv(mako_pred, "mako_pred_full.csv")
write.csv(mako_cor, "mako_cor_full.csv")
write.csv(mako_mae, "mako_mae_full.csv")
...
save(train_suzu, file = paste0("tuned_params_suzu_full", ".RData"))
...
for(i in 1:4){
  assign(paste0("suzu", i),
         suzu %>% filter(n_season == i) %>% select(log_abundance, do_0, do_5, do_10, do_20, do_50, sal_0, sal_5, sal_10, sal_20, sal_50, wt_0, wt_5, wt_10, wt_20, wt_50)
  )
}
...
write.csv(suzu_imp, "suzu_imp_full.csv")
write.csv(suzu_pred, "suzu_pred_full.csv")
write.csv(suzu_cor, "suzu_cor_full.csv")
write.csv(suzu_mae, "suzu_mae_full.csv")